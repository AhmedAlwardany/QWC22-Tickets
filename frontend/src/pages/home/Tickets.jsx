...
const Tickets = () => {
  ...
  const handleSubmit = (e, matchNumber) => {
    e.preventDefault();
    const match = data.filter((match) => match.matchNumber === matchNumber)[0];
    const id = match._id;
    navigate(`/reservation/${id}`, { state: { match } });
  };
  return (
    <div>
      <Navbar />
                ...
                <div className="match">
                  ...
                  <div className="bookButtonDiv">
                    <button
                      ...
                      onClick={(e) => handleSubmit(e, matchNumber)}
                    >
                      Book Now
                    </button>
                  </div>
